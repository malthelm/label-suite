...
export function BudgetItemForm({ releaseId, onClose }: { releaseId: string; onClose: () => void }) {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch("/api/budget-items", {
        ...
        body: JSON.stringify({ release_id: releaseId, name, amount: Number(amount), status }),
      });
